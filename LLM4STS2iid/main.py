...
if __name__ == '__main__':
    ...
    # base
    parser.add_argument('--model_name', type=str,default='gpt2-medium',help = 'the name of model')
    parser.add_argument('--text_file', type=str,default='../Dataset/Log2/iid-hf',help='text_ZH_root')
