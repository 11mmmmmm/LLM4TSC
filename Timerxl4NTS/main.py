...
if __name__ == '__main__':
    ...
    # base
    parser.add_argument('--model_name', type=str,default='Timerxl',help = 'the name of model')
    parser.add_argument('--data_file', type=str,default='../Dataset/Float/city_temp.csv')
    parser.add_argument('--data_flag', type=int, default=0, help='1:int,0:float')
    parser.add_argument('--decimals', type=int, default=1, help='0:int,1:city_temp,2:zh_root,6:gps')
