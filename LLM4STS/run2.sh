...
do
    ...
    echo "end"
    # python main.py --model_name 'Llama' --text_file "$data_file" --gpu 2 --win_size 256 --pred_len 1 --batch_size 1
    echo "end"
    # python main.py --model_name 'Llama13-hf' --text_file "$data_file" --gpu 2 --win_size 256 --pred_len 1 --batch_size 1
